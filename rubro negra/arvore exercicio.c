...
int main(){
    ...
    inserirArvore(4, &arvore);
    inserirArvore(2, &arvore);
    inserirArvore(8, &arvore);
    inserirArvore(1, &arvore);
    inserirArvore(3, &arvore);
    inserirArvore(6, &arvore);
    inserirArvore(9, &arvore);
    inserirArvore(5, &arvore);
    inserirArvore(7, &arvore);
